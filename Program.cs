...
namespace SistemaBancario
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Banco banco = new Banco("BANCO TECNM");
            bool salir = false;
        ...
        static void RegistrarNuevoCliente(Banco banco)
        {
            ...
            try
            {
                ...
                if (!DateTime.TryParse(fechaInput, out DateTime fechaNacimiento))
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("Error: El formato de fecha no es válido. Intente con DD/MM/AAAA.");
                    Console.ResetColor();
                    return; // Detiene el registro para que no intente guardar una fecha vacía
                }
